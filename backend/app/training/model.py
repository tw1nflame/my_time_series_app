...
class TrainingParameters(BaseModel):
    ...
    models_to_train: Optional[List[str]] = Field(None, description="Конкретные модели для обучения. Если None или пустой список, обучаются все доступные модели. Пример: ['DeepAR', 'Chronos'].")
